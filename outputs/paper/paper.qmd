...
The graph (@fig-area-of-origin) illustrates the distribution of fire incident by area of origin, we notice that Area 24, which is cooking area, and Area 81, which is the engine area are more prone to fire incidents. It underscores cooking and engine areas are high-risk zones for fire outbreaks due to the presence of heat sources and flammable materials.
